...
document.getElementById("logoutButton").addEventListener("click", () => {
  const confirmation = confirm("Espero te haya gustado amor,vuelve pronto,ti amu <3");
  if (confirmation) {
...
window.addEventListener("load", () => {
  ...
  if (anniversaryDate) {
    ...
    document.getElementById(
      "daysCount"
    ).innerText = `Ya han pasado ${months} ${monthText} y ${days} ${dayText}, desde que comenzó nuestra historia ,mi amor. Me alegra mucho estar a tu lado y disfrutar cada momento. ¡Ti Amuu❤️!`;
  }
});
